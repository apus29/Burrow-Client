...
class TXTRecordTests: XCTestCase {
    ...
    func testConstant() {
        ...
        try! DNSResolver.resolveTXT("constant.test.burrow.tech").then { response in
    ...
    func testBabies() {
        ...
        try! DNSResolver.resolveTXT("babies.test.burrow.tech").then { response in
            let txtRecords = try! response.unwrap()
    ...
    func testBacon() {
        ...
        try! DNSResolver.resolveTXT("bacon.test.burrow.tech").then { response in
            let txtRecords = try! response.unwrap()
