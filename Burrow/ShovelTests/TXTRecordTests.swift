...
class TXTRecordTests: XCTestCase {
    ...
    func testConstant() {
        ...
        DNSResolver.resolveTXT("constant.test.burrow.tech") { response in
    ...
    func testBabies() {
        ...
        DNSResolver.resolveTXT("babies.test.burrow.tech") { response in
            let txtRecords = try! response.unwrap()
    ...
    func testBacon() {
        ...
        DNSResolver.resolveTXT("bacon.test.burrow.tech") { response in
            let txtRecords = try! response.unwrap()
